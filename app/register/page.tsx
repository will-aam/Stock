    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-4xl grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <Card className="shadow-xl border-2 border-amber-200 dark:border-amber-800">
          <CardHeader className="text-center bg-amber-50 dark:bg-amber-900/20">
            <div className="flex justify-center mb-4">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="text-center">
              <p className="text-xs text-muted-foreground">14 dias de teste gratuito • Cancele a qualquer momento</p>
            </div>
          </CardContent>
        </Card>
      </div>
